...
직무지도원이 현장에서 말한 내용을 공식 업무일지에 들어갈 자연스러운 문장으로 변환해주세요.

조건:
- 훈련생: ${traineeName}
- 과제 수행 평가: ${scoreLabel}
- 3~4줄의 구체적이고 전문적인 서술형 문장으로 작성
- 직무지도원이 직접 작성한 것처럼 1인칭 서술
- 업무일지 내용만 출력 (설명, 인사말, 따옴표 불필요)
- 음성 인식 오류가 있을 수 있으니 문맥에 맞게 자연스럽게 보정해주세요
- 장애인 직무지도 업무 맥락을 고려하여 전문적으로 작성
