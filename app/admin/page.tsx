...
export default function AdminDashboardPage() {
  ...
  const SUMMARY_CARDS = [
    ...
    { label: "미확인 근태",     value: s?.unconfirmedCount ?? 0,    unit: "건", urgent: (s?.unconfirmedCount ?? 0) > 0, onClick: () => router.push("/admin/inbox/attendance") },
    { label: "보고서 제출 대기", value: s?.docPendingSubmit ?? 0,   unit: "건", urgent: false, onClick: () => router.push("/admin/documents") },
    { label: "보고서 미제출",   value: s?.docOverdue ?? 0,          unit: "건", urgent: (s?.docOverdue ?? 0) > 0, onClick: () => router.push("/admin/documents") },
    ...
    { label: "미배정 Site",     value: s?.unassignedSiteCount ?? 0, unit: "건", urgent: (s?.unassignedSiteCount ?? 0) > 0, onClick: () => router.push("/admin/sites") },
  ];
      ...
      <div className="grid grid-cols-[1fr_360px] gap-4">
        ...
        <div className="space-y-4">
          ...
          <Section title="근태 현황" sub="근무 중 직무지도원 근태 현황" count={s?.unconfirmedCount} onMore={() => router.push("/admin/inbox/attendance")}>
            ...
            <div className="border-t border-slate-100 pt-2.5">
              <button onClick={() => router.push("/admin/inbox/attendance")} className="text-xs font-black text-sky-600 transition hover:text-sky-700">
                → 근태 관리 바로가기
              </button>
            </div>
          </Section>
          ...
          <Section title="보고서 제출 현황" sub="직무지도원 문서 제출 현황" count={(s?.docPendingSubmit ?? 0) + (s?.docOverdue ?? 0)} onMore={() => router.push("/admin/documents")}>
            ...
            />
            <div className="border-t border-slate-100 pt-2.5">
              <button onClick={() => router.push("/admin/documents")} className="text-xs font-black text-sky-600 transition hover:text-sky-700">
                → 문서 관리 바로가기
              </button>
            </div>
          </Section>
          ...
          <Section title="배정 / 계약 현황" sub="배정 / 계약 이슈 현황" count={s?.endingIn10} onMore={() => router.push("/admin/coaches")}>
            ...
            />
            <div className="border-t border-slate-100 pt-2.5">
              <button onClick={() => router.push("/admin/coaches")} className="text-xs font-black text-sky-600 transition hover:text-sky-700">
                → 직무지도원 운영 바로가기
              </button>
            </div>
          </Section>
        ...
        <div className="space-y-4">
          ...
          <Section
            ...
            onMore={() => router.push("/admin/attendances")}
          >
