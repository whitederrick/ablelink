...
export default function ManagerSignaturePage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="관리자 서명 관리"
        sub={<>{displayName && `${displayName}님 · `}관리자의 서명은 직무지도원이 제출하는 일지에 자동으로 삽입됩니다.</>}
      />
      ...
      <div className={T.card}>
        ...
        <ul className="space-y-1.5 pl-5 text-sm font-semibold text-slate-500" style={{ listStyleType: "disc" }}>
          ...
          <li className="font-semibold text-rose-500">⚠️ 사업체 담당자의 서명은 저장 및 재활용이 불가합니다. 서명 필요 시 현장 즉시 서명으로 진행됩니다.</li>
