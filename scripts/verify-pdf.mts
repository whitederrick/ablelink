...
const cases: [any, string, any][] = [
  ...
  ["TRAINING_DAILY_LOG", "training-log", {
    ...
    holidays: ["2026-06-04"],
    rows: [
      { section: "PRE",   date: "2026-06-01", attendanceStatus: "출석", trainingTime: "4H", guidanceFlag: "Y", task: "오리엔테이션", taskLevelMeasured: "양호\n(5.5H)", evalGuidance: "기본 안내" },
      { section: "FIELD", date: "2026-06-03", attendanceStatus: "출석", trainingTime: "8H", guidanceFlag: "N", task: "포장 작업", taskLevelMeasured: "잘함\n(8H)", evalGuidance: "집중도가 좋아짐. 반복 지도 필요." },
      { section: "FIELD", date: "2026-06-05", attendanceStatus: "지각", trainingTime: "8H", guidanceFlag: "N", task: "라벨 부착", taskLevelMeasured: "보통\n(8H)", evalGuidance: "속도 향상 지도." },
    ], signatures: sig,
  }],
  ["ADAPTATION_DAILY_LOG", "adaptation-log", {
    ...
    holidays: ["2026-06-04"],
    entries: [
      { dateISO: "2026-06-01", attendance: "출석", workTime: "08:30~13:30", guidance: "Y", task: "오리엔테이션", performanceLabel: "양호", performanceTime: "5.5H", coaching: "기본 안내" },
      { dateISO: "2026-06-02", attendance: "출석", workTime: "08:30~13:30", guidance: "Y", task: "분류 작업", performanceLabel: "잘함", performanceTime: "5.5H", coaching: "자율 수행을 기본으로 지켜보았습니다. 다만, 일부 힘든 일이 발생 시 제대로 대응하지 못하는 경우가 발생하여 별도 지도하였습니다." },
      { dateISO: "2026-06-03", attendance: "출석", workTime: "08:30~13:30", guidance: "Y", task: "단순 업무", performanceLabel: "양호", performanceTime: "5.5H", coaching: "자율 수행" },
    ],
