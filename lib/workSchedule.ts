...
//
// 규칙(2026-06-08 확정):
//  - 오전 4시간(AM): 출퇴근지도+휴게지도 포함(기본) → 08:30~14:00 / 미포함(예외) → 09:00~13:30
...
//
// 4시간 근무 원칙: 4시간 근무당 휴게 30분 추가.
//  · AM 미포함 09:00~13:00(근무4h)+휴게30분 = 13:30
//  · PM 미포함 13:00~17:00(근무4h)+휴게30분 = 17:30
//  · "포함"은 출근 전 30분 + 퇴근 후 30분(출퇴근 지도)을 앞뒤로 확장한 값.
