...
// 서비스 이용약관 본문 — 단일 출처. /terms 페이지와 앱 내 모달(LegalDocModal)이 공유.
    ...
    <div className="space-y-8 text-sm font-semibold leading-7 text-slate-700">
      ...
      <section>
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          <li>"서비스"란 회사가 제공하는 장애인 직무지도원 업무관리 플랫폼 Able-Link 및 부가 서비스 Office-Link를 의미합니다(이하 "서비스").</li>
          <li>"직무지도원"이란 장애인 직무지도 서비스를 제공하는 자로 서비스에 가입한 개인 이용자를 말합니다.</li>
          <li>"위탁기관"이란 직무지도원을 고용·위탁하여 장애인 고용 지원 서비스를 운영하는 기관을 말합니다.</li>
          <li>"훈련생"이란 직무지도 서비스의 대상이 되는 장애인을 의미하며, 서비스 내 입력되는 데이터의 주체입니다.</li>
      ...
      <section>
        ...
        <ol className="list-decimal space-y-1.5 pl-5">
          ...
          <li>회사는 서비스의 안정적인 운영을 위하여 점검을 실시할 수 있으며, 정기 점검 시간은 사전에 서비스 화면에 공지합니다.</li>
          <li>회사는 불가피한 사유가 있을 경우 서비스의 일부 또는 전부를 수정하거나 변경할 수 있으며, 이용자에게 중대한 영향을 미치는 경우 제3조에 따라 공지합니다.</li>
        </ol>
      </section>
      ...
      <section>
        <h2 className="mb-3 text-base font-black text-slate-900">제9조 (분쟁 해결 및 관할 법원)</h2>
        <p>서비스 이용과 관련한 분쟁은 대한민국 법률을 준거법으로 합니다. 서비스 이용과 관련하여 회사와 이용자 사이에 분쟁이 발생하여 소송이 제기되는 경우, 「민사소송법」상 관할 법원을 관할 법원으로 합니다.</p>
      </section>
